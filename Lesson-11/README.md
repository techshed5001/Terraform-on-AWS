# Lesson 11: Terraform Data Sources with AWS
...
```bash
cd lessons/lesson-11/code/setup
terraform init
terraform apply
```
...
```bash
cd ../.. # Go back to the lesson-11/code directory
terraform init
terraform plan
```
...
2.  Find the instance named `daylesson-11-instance`.
